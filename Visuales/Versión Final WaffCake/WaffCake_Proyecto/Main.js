...
var cajaTotal = UserCaja[0] - UserCaja[1];

if(cajaTotal < 0){
    alert("La caja esta en numeros rojos, ¡Ten cuidado pudes generar deudas :¨( !");
    //Función que jala el dinero en caja // 
    document.getElementById('cantidad-caja').innerHTML = (" " + cajaTotal); // --> DINERO EN CAJA
}else if(cajaTotal == 0){
    alert("La caja esta en 0, ¡Ten cuidado pudes generar deudas :¨( !");
    //Función que jala el dinero en caja // 
    document.getElementById('cantidad-caja').innerHTML = (" " + cajaTotal); // --> DINERO EN CAJA
}else{
    //Función que jala el dinero en caja // 
